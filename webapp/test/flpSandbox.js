		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Delivery Creation With Order Referance",
									"targetURL": "#zsddeliverycreation-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"zsddeliverycreation-display": {
								"semanticObject": "zsddeliverycreation",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=zsddeliverycreation",
									"url": sap.ui.require.toUrl("zsddeliverycreation")
								}
							}
						}
					}
